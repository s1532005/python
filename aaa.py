...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        var.set(0)
        rdo1 = tk.Radiobutton(tki, value=0, variable=var, text='Hilight（上手いプレイ）集')
        rdo2 = tk.Radiobutton(tki, value=1, variable=var, text='Funny(盛り上がった)場面集')
        
        rdo1.grid(row=1,column=0)     #frame2を配置(綴じる)
        rdo2.grid(row=1,column=1)     #frame2を配置(綴じる)
